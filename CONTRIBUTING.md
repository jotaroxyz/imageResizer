...
You are welcome to contribute to this project, whether it's reporting a bug, suggesting an improvement, submitting fixes/improvements/new code. To ensure a smooth collaboration process please follow these guidelines.

## Found a bug?

### Search for existing issues

Before creating a new issue, please search existing [issues](https://github.com/jotaroxyz/imageResizer/issues) to see if it has already been reported.
...
Changes may be declined if they do not align with the design philosophy of this project, are incomplete, not well-planned, or introduce unnecessary complexity or breaking changes to the codebase.
...
This Contributor License Agreement ("Agreement") is entered into between the contributor ("Contributor") and Ren ("Owner") for the purpose of contributing to this repository (the "Project").
